...
* */
  ...
  public static String[] VerCreate(String txt) {
    ...
    * */
   public static String queryBridgeWords(String word1, String word2, String text) {
   ...
   public static void main(String args[]){
	   ...
	   while (true) {
		   ...
		   case 2:
			   ...
			   String bridge = queryBridgeWords(begin, end, test);
			   if (bridge.equals("")) {
		   ...
		   case 3:
			   ...
			   String NewText = generateNewText(sentence, test);
